...
st.markdown("""<div style="text-align: center; padding: 2rem 0; background: linear-gradient(135deg, #2196F3 0%, #1976D2 100%); border-radius: 0.5rem; color: white; margin-bottom: 2rem;">
